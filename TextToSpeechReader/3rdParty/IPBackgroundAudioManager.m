...
- (void)audioRouteDidChange:(NSNotification *)notification
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:IPBackgroundAudioNotificationRouteChanged object:self userInfo:userInfo];
    ...
    if (routeChangeReason == AVAudioSessionRouteChangeReasonOldDeviceUnavailable) {
        [[NSNotificationCenter defaultCenter] postNotificationName:IPBackgroundAudioNotificationRouteUnavailable object:self userInfo:userInfo];
    }
}
